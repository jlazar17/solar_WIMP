...
eval `/cvmfs/icecube.opensciencegrid.org/py3-v4/setup.sh` python /data/user/jlazar/solar_WIMP/calc_energy_delta_theta_hist_signal_bivariate_spline.py ${RUNN} ${NUTYPE} ${CH} ${MCHI}
